...
// IsOrderFilled provides a mock function with given fields: orderNumber, _
func (_m *PrivateClient) IsOrderFilled(orderNumber string, _ string) (bool, error) {
	ret := _m.Called(orderNumber, _)
